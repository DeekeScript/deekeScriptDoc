import{_ as a,c as s,o as n,ah as t}from"./chunks/framework.DhC5tf0O.js";const b=JSON.parse('{"title":"混淆加密","description":"DeekeScript - 混淆加密","frontmatter":{"title":"混淆加密","description":"DeekeScript - 混淆加密"},"headers":[],"relativePath":"code/encryption.md","filePath":"code/encryption.md"}'),p={name:"code/encryption.md"};function o(i,e,l,r,c,u){return n(),s("div",null,e[0]||(e[0]=[t(`<h1 id="混淆加密" tabindex="-1">混淆加密 <a class="header-anchor" href="#混淆加密" aria-label="Permalink to “混淆加密”">​</a></h1><p>JavaScript代码混淆，一定程度上达到了保护原代码的目的。DeekeScript默认采用了UglifyJS插件进行代码混淆。</p><blockquote><p>注意：开发模式下不建议使用混淆，生产环境可以使用混淆。同时还需要了解到混淆之后，给生产bug排查带来了一定阻碍。</p></blockquote><h2 id="uglifyjs" tabindex="-1">UglifyJS <a class="header-anchor" href="#uglifyjs" aria-label="Permalink to “UglifyJS”">​</a></h2><blockquote><p>UglifyJS 是一个 JavaScript 压缩与混淆工具，专注于减少代码体积、优化逻辑结构，并提供基础的变量名混淆功能。它是前端工程化中常用的代码优化工具。</p></blockquote><h3 id="核心功能" tabindex="-1">核心功能 <a class="header-anchor" href="#核心功能" aria-label="Permalink to “核心功能”">​</a></h3><blockquote><p>代码压缩</p></blockquote><pre><code>删除空格、换行、注释。
