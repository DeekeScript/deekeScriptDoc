import{_ as a,l as s,n as e,q as p}from"./chunks/theme.DmEsGR88.js";const h=JSON.parse('{"title":"多线程-Thread","description":"DeekeScript - 多线程-Thread","frontmatter":{"title":"多线程-Thread","description":"DeekeScript - 多线程-Thread"},"headers":[],"relativePath":"advance/thread.md","filePath":"advance/thread.md"}'),l={name:"advance/thread.md"};function r(i,n,t,c,b,d){return e(),s("div",null,n[0]||(n[0]=[p(`<h1 id="多线程-thread" tabindex="-1">多线程-Thread <a class="header-anchor" href="#多线程-thread" aria-label="Permalink to “多线程-Thread”">​</a></h1><p>相信富有经验的开发者，会发现很多工具都有提供多线程支持；因为很多时候，我们需要同时执行两个操作（比如，采集直播间弹幕的时候，又要实时获取在线人数）；这个时候使用多线程的方式可以更好地满足我们的需求。DeekeScript本身也是支持多线程的；</p><p><code>我们推荐使用setTimeout或者setInterval等方式来代替多线程的方式实现相关功能，或者使用Engines来实现多线程</code></p><blockquote><p>使用<a href="./engines/engines.html">Engines</a>来实现多线程效果</p><p>使用<a href="./../base/timer/timer.html">setInterval</a>定时器，通过异步的方式来实现系统的效果</p></blockquote><h2 id="多线程使用" tabindex="-1">多线程使用 <a class="header-anchor" href="#多线程使用" aria-label="Permalink to “多线程使用”">​</a></h2><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>let obj = {</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div>`,8)]))}const u=a(l,[["render",r]]);export{h as __pageData,u as default};
