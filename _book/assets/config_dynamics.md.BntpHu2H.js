import{_ as p,c as e,o as l,ah as n,j as s}from"./chunks/framework.BJ6Xb1OP.js";const m=JSON.parse('{"title":"动态配置","description":"DeekeScript - 动态配置","frontmatter":{"title":"动态配置","description":"DeekeScript - 动态配置"},"headers":[],"relativePath":"config/dynamics.md","filePath":"config/dynamics.md"}'),t={name:"config/dynamics.md"};function i(r,a,u,o,c,b){return l(),e("div",null,a[0]||(a[0]=[n('<h1 id="动态配置" tabindex="-1">动态配置 <a class="header-anchor" href="#动态配置" aria-label="Permalink to “动态配置”">​</a></h1><p>很多时候，开发者需要控制app主页的功能模块，比如年会员展示所有功能图标，试用会员只展示部分图标等；同时，有时候还需要根据不同等级的用户来设置不同的功能配置参数。这样更加细化盈利策略。</p><h2 id="deekescriptjson" tabindex="-1">DeekeScriptJson <a class="header-anchor" href="#deekescriptjson" aria-label="Permalink to “DeekeScriptJson”">​</a></h2><p>DeekeScript给开发者提供了DeekeScriptJson对象，可以使用此对象来进行主界面功能模块设置、功能参数设置、设置页面的动态配置等</p><h3 id="setdeekescriptjsongroup-str" tabindex="-1">setDeekeScriptJsonGroup(str) <a class="header-anchor" href="#setdeekescriptjsongroup-str" aria-label="Permalink to “setDeekeScriptJsonGroup(str)”">​</a></h3>',5),s("blockquote",null,[s("p",{string:""},"str"),s("p",null,"返回 {boolean} 如果出错，会抛出异常")],-1),n(`<div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>//这里可以调用远程接口来获取数据</span></span>
