import{_ as n,c as a,o as e,ah as p}from"./chunks/framework.BJ6Xb1OP.js";const d=JSON.parse('{"title":"DeekeScript异步","description":"DeekeScript - DeekeScript异步","frontmatter":{"title":"DeekeScript异步","description":"DeekeScript - DeekeScript异步"},"headers":[],"relativePath":"promise/awa.md","filePath":"promise/awa.md"}'),l={name:"promise/awa.md"};function i(r,s,c,t,o,b){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="deekescript异步" tabindex="-1">DeekeScript异步 <a class="header-anchor" href="#deekescript异步" aria-label="Permalink to “DeekeScript异步”">​</a></h1><h3 id="promise" tabindex="-1">Promise <a class="header-anchor" href="#promise" aria-label="Permalink to “Promise”">​</a></h3><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>let promise = new Promise(function (resolve, reject) {</span></span>
