...
### DeekeScript优势
> 从“嘀客APP”到“Deeke”，DeekeScript解决了：稳定性差、软件不流畅、ui设计差、软件体验差等问题。DeekeScript让一个程序员同时兼顾了ui设计师、产品经理的能力；同时让开发效率大幅提升。

* 采用JavaScript/TypeScript编写脚本，无需懂Android
